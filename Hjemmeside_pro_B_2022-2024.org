...
** Uge 24 Torsdag d. 13. juni 2024
Så er det på mandag og tirsdag i næste uge, at I skal til eksamen i programmering B. Det var kun ca halvdelen af jer, som dukkede op til spørgetimen, så derfor får I alle lige en sidste reminder om eksamensformen.

1. Træk af *ukendt* eksamensspørgsmål med udgangspunkt i mindre programmer, som I i første omgang skal forstå og siden udvide.
2. 60 minutters forberedelsestid til at arbejde med eksamensspørgsmålet. I skal bruge jeres egen laptop og der er fri adgang til internettet. I må dog *ikke* kommunikere med andre personer.
3. 30 minutters eksamination.
   - Først præsenterer I jeres eksamensprojekt, og så får I spørgsmål til eksamensprojektet. Forvent, at der mere er tale om en samtale end en forelæsning fra jeres side.
   - Efterfølgende præsenterer I jeres arbejde med det udtrukne eksamensspørgsmål. Her skal I også forvente en samtale frem for en forelæsning.
   - Der er ca. 12.5 minut til hver del inkl spørgsmål/samtale.
   - Der bruges 5 minutter på karaktergivning og udskiftning af elever.

Det er en god idé at have følgende pythonbiblioteker installeret i et nyt virtuelt miljø tilegnet eksamen (eller globalt i jeres pythoninstallation):
- =arcade=
- =matplotlib=
- =PySide6=
- =sympy=

Det er alle biblioteker, vi har anvendt i undervisningen.

Ud over dette, har vi også arbejdet med Lego Mindstorms, så det skal I også være klar på at kunne arbejde med.

Det nemmeste er at anvende Visual Studio Code og så installere de to plugins som har med ev3 at gøre.

Brug følgende vejledning, som I også burde have set før: https://github.com/jonascj/lego-mindstorms-ev3dev-python-how-to

Alternativt kan I også bruge =git-bash= (eller en anden terminal/shell) til at tilgå ev3'erne. I førnævnte vejledning står der også lidt om brugen af en terminal.

For at kunne tilgå ev3'erne skal I bruge =ssh= fra en shell (git-bash). Brugernavnet til ev3'erne er =robot= mens kodeordet er =maker=. Brug kommandoen

=ssh robot@ipadresse=

hvor ipadressen kan findes oppe  øverst på ev3'erens skærm, når den er startet op. I skal huske at være på =Next-Guest=-netværket.

Vi/I har typisk brugt editoren =nano= til at ændre i koden, og programmerne har typisk været kørt med kommandoen

=brickrun -r -- pybricks-micropython programfilnavn.py=

** Uge 23 Tirsdag d. 4. juni 2024
I dag afholder vi spørgetime i programmering B. Kom frisk, kom glad så I kan få den bedst mulige forberedelse til jeres eksamen.
...
- I kan finde en skabelon til opbygningen af synopserne i filerne =synopsis.md= og =synopsis.org= i jeres git repos. I behøver bestemt ikke at skrive i markdown eller ord mode. I må gerne skrive jeres synopser i f.eks. word eller lignende. Når I skal indsætte kodestumper i word, så følg den vejledning, som også står i =synopsis.md=.
- Det skal tydeligt fremgå i jeres synopser og jeres fælles kode, hvilke ansvarsområder de forskellige gruppemedlemmer har haft i projektarbejdet.
...
#+begin_src plantuml :file img/gantt.png :eval never-export :exports both
@startgantt
language da
title Gantt-diagram over eksamensprojektet
mondays are closed
tuesdays are closed
...
project starts 2024-02-22 
2024-05-06 to 2024-05-11 are named [Sidste uge] 
2024-05-12 is colored in red
2024-03-03 to 2024-03-08 are colored in gray and is named [Studietur] and are closed

2024-03-15 to 2024-03-15 is named [SOP vejledning] and is colored gray
2024-03-25 to 2024-04-1 are closed and is named [Påskeferie] and is colored in gray

2024-04-08 to 2024-04-12 are colored in gray and is named [SOP-dage] and are closed
2024-04-15 to 2024-04-19 are colored in gray and is named [SOP skriveuge] and are closed
2024-04-22 to 2024-04-26 are colored in gray and is named [værkstedsuge] and are closed
-- Idegenereringsfase --
[Idegenerering] requires 2 weeks
-- Arbejdsfase --
[Prototype Model] on {J. Cleese} starts after [Idegenerering]'s end and requires 3 weeks
note bottom
Kort
Kortdæk
Regler 
end note
[Prototype View] on {E. Idle} starts after [Idegenerering]'s end and requires 3 weeks
note bottom
Implementeret i arcade
kortbagside
kortforside
baggrund
end note

[Prototype Controller] on {M. Palin} starts after [Idegenerering]'s end and requires 3 weeks
note bottom
Først cli-prototype
Siden GUI-prototype
end note
-- Afslutningsfase --
[Færdiggøre program] on {J. Cleese} {E. Idle} {M. Palin} starts 2024-04-28 and ends 2024-05-12
[J. Cleese synopsis] starts 2024-04-28 and ends 2024-05-12
[E. Idle synopsis] starts 2024-04-28 and ends 2024-05-12
[M. Palin synopsis] starts 2024-04-28 and ends 2024-05-12

[Deadline] happens at 2024-05-12
...
*** [2024-02-29 tor] og [2024-03-01 fre]
...
*** [2023-09-06 ons]                                   :Databehandling:csv:
...
** Eksamensprojekt
*** Indhold og fokus
Arbejdet med eksamensprojektet er inddelt i 3 faser. En opstartsfase, en arbejdsfase samt en afslutningsfase.
Opstartsfasen lægger ud med gruppedannelse ud fra projektoplæggets 5 overemner og bliver efterfulgt af idégenerering, idésortering, kravspecifikation samt projektbeskrivelse. Der kan ses mere om denne opstartsfase i den tilhørende præsentation under anvendt materiale.
*** Faglige mål
Eleverne skal kunne:
...
- Større projekt om udvikling af geogebraklon:
  [[https://github.com/Vibenshus-Gymnasium-Programmering/Databehandling_projekt_Pythobra][Projekt Pythobra]]
*** Arbejdsformer
- Use-Modify-Create
...
- Diverse opgaver:
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/PySide6_andengradsligningsloeser.git][Opgave 01 Grafisk andengradsligningsløser]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/roeversprogsoversaetter.git][Opgave 02 Røversprogsoversætter]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/PySide6_Kryds_og_bolle][Opgave 03 Kryds og bolle]]
*** Arbejdsformer
- Use-Modify-Create
...
- Diverse opgaver:
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/Arcade_Opgave_01_Foerste_program.git][Opgave 01 Printfunktionen]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/Arcade_Opgave_02_Tegn_et_billede.git][Opgave 02 Tegn et billede]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/Arcade-Opgave-03-Tegn-med-funktioner.git][Opgave 03 Tegn med funktioner]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/Arcade_Opgave_04_Flugten_paa_Dune.git][Opgave 04 Flugten på Dune]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/Arcade_Opgave_5_Tegn_med_loekker.git][Opgave 05 Tegn med løkker]]
  - [[https://github.com/Vibenshus-Gymnasium-Programmering/Opgave_06_Arkanoid.git][Opgave 06 Arkanoid]]
*** Arbejdsformer
- Use-modify-create
- Individuelt
- Gruppearbejde
